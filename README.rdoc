...
The 1.x.x version of the library is designed to work with Ruby 2.4+. This is because the library was upgraded to use the +Integer+ class instead of +Fixnum+.
