...
The rate_limit method can be used at the end of a class definition to limit specific instance methods. 
    ...
    rate_limit :name_of_instance_method, <Number of Executions>, <Timeframe in Seconds>

The specified instance method will be throlled to maintain an execution rate of `<Timeframe in Seconds> / <Number of Executions>`.
