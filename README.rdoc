...
2. Before the next execution the process will sleep to wait for the current m second time period to elapse.
...
The amount of time slept before each execution will depend on both the time period m and the amount of time each task takes to execute.
